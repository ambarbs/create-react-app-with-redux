## React with Redux (bootstrap)

- This project is a bootstrapped version of Redux along with create-react-app. [Create React App](https://github.com/facebookincubator/create-react-app).

- **appStore.js** is preconfigured with a couple of reducers as examples but feel free to change them according to your project requirements.

- **reducers.js** contains a couple of sample reducers

- **actions.js** contains a couple of sample actions 

- The above reducers and actions are samples, which could be modified/added.removed according to business requirements. 
...
## Table of Contents as is from "Create React App"
